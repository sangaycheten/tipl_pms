        ...
        <table class="table table-bordered table-condensed">
            ...
            @forelse($onmTargets as $detail)
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <input type="number" class="text-right goal-weightage" min="0" step="any" max="{{$detail->Weightage}}" style="width:100%;" required="required" name="goaldetailonm[{{$randomKey}}][Level1Score]" value="{{$detail->Level1Score}}"/><?php $level1ScoreTotal += doubleval($detail->Level1Score); ?>
                    </td>
                    <td class="text-center">
                        <textarea style="width:100%;" rows="2" name="goaldetailonm[{{$randomKey}}][SelfRemarks]">{{$detail->Level1Remarks}}</textarea>
                    </td>
                </tr>
                <?php $count++; ?>
            @empty
        ...
        <table class="table table-bordered table-condensed">
            ...
            @forelse($goalTargets as $detail)
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <textarea style="width:100%;" rows="2" name="goaldetailpna[{{$randomKey}}][SelfRemarks]">{{$detail->Level1Remarks}}</textarea>
                    </td>
                </tr>
                <?php $count++; ?>
            @empty
