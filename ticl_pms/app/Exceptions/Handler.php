...
//        HttpException::class,
    ...
    public function render($request, Exception $e)
    {
        ...
        if($e instanceof FatalErrorException || $e instanceof HttpException || $e instanceof ErrorException || $e instanceof TokenMismatchException || $e instanceof QueryException || $this->isHttpException($e)){
            $this->saveError($e);
