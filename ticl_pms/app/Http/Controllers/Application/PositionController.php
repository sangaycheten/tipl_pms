...
class PositionController extends Controller
{
    ...
    public function getForm($id = null)
    {
        ...
        if ((bool) $id) {
            ...
            $positionDepartmentMaps = DB::table('mas_positiondepartment')->where('PositionId', $id)->lists('DepartmentId');
        }
    ...
    public function postSave(Request $request)
    {
        ...
        try {
            ...
            $mappedDepartmentIds = PositionDepartment::where('PositionId', $inputs['Id'])->lists('DepartmentId');
    ...
    {
        $inputs = Input::except('criteria');
        $criteriaInputs = Input::get('criteria');
        $criteriaId = [];
        $save = true;
        $hasCriteria = false;
        DB::beginTransaction();
