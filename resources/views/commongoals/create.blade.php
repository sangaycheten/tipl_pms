@extends('master')
@section('page-title', 'Add Common Goals')
@section('page-header', 'Add Common Goals')
...
<style>
    ...
    .picker-dept-bar .dept-count {
        font-size:0.75rem; color:#fff; background:#226b86;
    ...
    .picker-section-bar {
        ...
        background:#f8fbfd; border-top:1px solid #eaf0f5;
        cursor:pointer;
    }
    ...
    .selected-pills { display:flex; flex-wrap:wrap; gap:6px; min-height:36px;
        padding:6px 10px; border:1px solid #d0dce4; border-radius:6px;
        background:#f9fbfd; }
    .pill {
        display:inline-flex; align-items:center; gap:4px;
        background:#226b86; color:#fff; border-radius:30px;
        padding:3px 10px 3px 10px; font-size:0.78rem; white-space:nowrap;
    }
    .pill .pill-x { cursor:pointer; font-size:1rem; line-height:1;
        opacity:0.7; border:none; background:transparent; color:#fff; padding:0 0 0 4px; }
...
<form method="POST" action="{{ route('commongoal.store') }}" id="goalForm">
    @csrf
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <span class="text-warning">
            ...
            Select employees, add goals, then save.
        </span>
        <div>
            ...
            <div class="card" style="padding:14px 16px; border:1px solid #d0dce4;">
                ...
                <div class="picker-toolbar mb-2">
                    ...
                    <button type="button" class="btn btn-sm btn-link p-0 ml-1"
                            style="color:#226b86;white-space:nowrap;" onclick="selectAllVisible()">
                        All
                    </button>
                    <button type="button" class="btn btn-sm btn-link p-0 ml-1"
                            style="color:#dc3545;white-space:nowrap;" onclick="clearAll()">
                        Clear
                    </button>
                </div>
