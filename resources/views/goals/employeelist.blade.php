                                                    ...
                                                    <td class="text-center" style="font-weight:bold;padding: 0.45rem 0.4rem 0.4rem 0.4rem;">
                                                        ...
                                                        @else
                                                            ...
                                                            @if((bool)$employee->GoalDefinitionId)
                                                                ...
                                                                <a href="{{url('setnewgoal',[$employee->Id,2])}}"  class="@if(!$notWithinPMSPeriod){{""}}@endif btn btn-xs btn-warning">
                                                                    @if(!(bool)$employee->SubmittedAt && (bool)$employee->PMSSubmissionId)
                                                                        <i class="fa fa-edit"></i> Appraise Goal - {{date('Y')}} H2
                                                                    @elseif (!(bool)$employee->PMSSubmissionId)
                                                                        <i class="fa fa-edit"></i> Edit Goal - {{date('Y')}} H2
                                                                    @else
                                                                        <i class="fa fa-eye"></i> View Goal - {{date('Y')}} H2
                                                                    @endif
                                                                </a>
                                                            @else
                                                                ...
                                                                <a href="{{url('setnewgoal',[$employee->Id,2])}}"  class="@if(!$notWithinPMSPeriod){{""}}@endif btn btn-xs btn-success"><i class="fa fa-eye"></i> Set Goal - {{date('Y')}} H2 &nbsp;&nbsp;</a>
                                                            @endif
                                                        @endif
                                                        {{--@if((bool)$employee->GoalDefinitionId)
