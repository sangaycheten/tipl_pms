@extends('master')
@section('page-title','Employees Eligible for Meritorious')
@section('page-header',"Employees Eligible for Meritorious")
@section('content')
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="row">
                        ...
                        <form action="" method="GET" id="form-daterestriction">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6" style="margin-top:8px;">
                                    ...
                                    <a href="{{URL::to('eligibleformeritoriousreport')}}" style="" class="btn btn-danger"><i class="fa fa-times"></i> Clear</a> &nbsp;
				    {{-- <button type="button" onclick="window.location.href='{{url("eligibleformeritoriousreport")}}?export=excel&DepartmentId={{Request::get('DepartmentId')}}'" class="btn btn-success"><i class="fa fa-file-excel-o"></i> &nbsp;Export to Excel</button> --}}
				    &nbsp;
				    <a href="{{ URL::to('eligibleformeritoriousreport') . "?export=excel&" . Request::getQueryString() }}" class="btn btn-success"><i class="fa fa-file-excel-o"></i> &nbsp;Export to Excel</a>
                                </div>
                            </div>
			</form>
				...
				{{-- <h6 style="text-decoration: none;">Eligible for Meritorious Promotion by Outstanding Scores</h6> --}}
				<h6 style="text-decoration: none;">Eligible for Meritorious Promotion Based on Outstanding Category</h6>
						...
						@endif
                                ...
                                <br/>
                                <br/>
				{{-- <h6 style="text-decoration: none;">Eligible for Meritorious Promotion by Mix of Good and Outstanding Scores</h6> --}}
				<h6 style="text-decoration: none;">Eligible for Meritorious Promotion Based on Good Category</h6>
                                <div class="table-responsive">
                                    <table class="table table-condensed table-bordered">
                                        <thead>
                                            <tr>
