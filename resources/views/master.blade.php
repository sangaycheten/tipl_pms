                    ...
                    @if(Auth::user()->PositionId != CONST_POSITION_MD)
                        ...
                        @if(Auth::user()->DepartmentId == 7)
                            @if(in_array(Auth::user()->PositionId,[CONST_POSITION_HOD,CONST_POSITION_HOS]))
                                ...
                                <li class="treeview @if($currentRoute=='commongoal'){{"active"}}@endif">
                                    <a class="waves-effect waves-dark " href="{{URL::to('commongoal')}}">
                                        <i class="fa fa-check"></i><span> Set Common Goals</span>
                                    </a>
                                </li>
                            @endif
                            @if(Auth::user()->PositionId != CONST_POSITION_HOD)
                                ...
                                <li class="treeview @if($currentRoute=='individualpmsgoal'){{"active"}}@endif">
                                    <a class="waves-effect waves-dark " href="{{URL::to('individualpmsgoal')}}">
                                        <i class="fa fa-check"></i><span> My Goals</span>
                                    </a>
                                </li>
                            @endif
